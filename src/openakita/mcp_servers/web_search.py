...
ENGINE_BAIDU = SearchEngine("baidu", "百度", "https://www.baidu.com/s",
    lambda q, n: {"wd": q, "rn": str(n)}, _parse_baidu,
...
ENGINE_360 = SearchEngine("360", "360搜索", "https://www.so.com/s",
    lambda q, n: {"q": q},
    _make_standard_parser(_SO360_BLOCK_RE, _SO360_TITLE_RE, _SO360_SNIPPET_RE))
...
ENGINE_SOGOU = SearchEngine("sogou", "搜狗", "https://www.sogou.com/web",
    lambda q, n: {"query": q},
    _make_standard_parser(_SOGOU_BLOCK_RE, _SOGOU_TITLE_RE, _SOGOU_SNIPPET_RE))
